...
var ProjectsPostsListComponent = (function () {
    function ProjectsPostsListComponent(pageHeaderService, postService, router) {
    ...
    ProjectsPostsListComponent.prototype.ngOnInit = function () {
        ...
        this.postService.getPosts("projects").subscribe(function (posts) { return _this.posts = posts; }, function (error) { return _this.errorMessage = error; });
        ;
    };
    ProjectsPostsListComponent.prototype.onSelect = function (postId) {
