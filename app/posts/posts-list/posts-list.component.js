...
var PostsListComponent = (function () {
    function PostsListComponent(pageHeaderService, postService, router) {
    ...
    PostsListComponent.prototype.ngOnInit = function () {
        ...
        this.postService.getPosts("").subscribe(function (posts) { return _this.posts = posts; }, function (error) { return _this.errorMessage = error; });
    };
    PostsListComponent.prototype.onSelect = function (postId) {
