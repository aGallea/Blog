...
var PostsListComponent = (function () {
    function PostsListComponent(pageHeaderService, postService) {
    ...
    PostsListComponent.prototype.ngOnInit = function () {
        ...
        this.postService.getRecentPosts().subscribe(function (posts) { return _this.posts = posts; }, function (error) { return _this.errorMessage = error; });
        ;
    };
